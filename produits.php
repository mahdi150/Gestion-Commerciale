                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 about-title">
                        ...
                        <div class="row"style="margin-top: 100px;">
                            <a type="button" class="btn button primary-button text-uppercase  nav-link" href="fonction/ajoutProd.php"> Ajouter</a></button>
                            <a type="button" class="btn button primary-button text-uppercase  nav-link" href="fonction/rechercheProd.php"> Rechercher</a></button>
                            <!-- <a type="button" class="btn button primary-button text-uppercase  nav-link" href="fonction/supprimerProd.php"> Supprimer</a></button>
                            <a type="button" class="btn button primary-button text-uppercase  nav-link" href="fonction/modifieProd.php"> Modifier</a></button>
                            -->
                        </div>
                    </div>
                </div>
