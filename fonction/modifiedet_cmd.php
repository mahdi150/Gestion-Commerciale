                                ...
                                <div class="col-sm-12">
                                    <form class="md-float-material form-material" action="#" method="POST">
                                        <div class="auth-box card">
                                                ...
                                                <div class="form-group form-primary"> <input type="text" class="form-control" name="ref" value="<?php if(isset($_POST['refProd'])) echo($_POST['refProd']); ?>" placeholder="Refference Produit " required> </div>
                                                <div class="form-group form-primary"> <input type="text" class="form-control" name="cc" placeholder="Quantite Commandé" value="<?php if(isset($_POST['qteCmd'])) echo($_POST['qteCmd']); ?>" required> </div>
                                                <div class="row">
                                                <button type="submit" name="modifie" class="btn btn-primary btn-md btn-block  text-center"><i class="fa-solid fa-square-plus"></i></i> Modifier </button>
                                                </div>
                                        </div>
                                    </form>
                                </div>
...
function modifier_detail_client($i,$n,$r){
    $link = mysqli_connect('localhost', 'root', '', 'gestioncommerciale');
    $sql = "UPDATE `detailcom` SET `numCommande`=$i,`refProd`=$n,`qteCmd`=$r WHERE `numCommande`=$i ";
...
if(isset($_POST['modifie'])){
    ...
    modifier_detail_client($_POST['num'],$_POST['ref'],$_POST['cc']);
   // header('location:../clients.php');
}
