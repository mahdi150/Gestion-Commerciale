    ...
    <main class="site-main">
        ...
        <?php
                        ...
                        <td>
                         ...
                         $query = "SELECT * FROM produit where refProd=$ref";
                      ...
                      ?>
                       ...
                       <td>
                           <form method="post" action="">
                               <input type="hidden" name="supp" value="<?php echo($row["refProd"]); ?>">
                        ...
                        <form method="post" action="modifieProd.php">
                               <input type="hidden" name="refProd" value="<?php echo($row["refProd"]); ?>">
                               <input type="hidden" name="nomProd" value="<?php echo($row["nomProd"]); ?>">
                               <input type="hidden" name="pu" value="<?php echo($row["pu"]); ?>">
                               <input type="hidden" name="qteStock" value="<?php echo($row["qteStock"]); ?>">
                               <input type="hidden" name="indisponible" value="<?php echo($row["indisponible"]); ?>">
...
<?php
    ...
    function supprimer_produit($ref){
        ...
        echo"<script>alert('Produit a ete bien Supprimer  !')</script>";
        //éheader('location:../produits.php');
    }
